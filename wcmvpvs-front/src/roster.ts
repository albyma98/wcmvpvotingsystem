...
export const PLAYER_LAYOUTS: Record<number, PlayerLayoutSlot[]> = {
  12: [
    { tier: 'gold', position: { x: 20, y: 20 } },
    { tier: 'gold', position: { x: 50, y: 20 } },
    { tier: 'silver', position: { x: 80, y: 20 } },
    { tier: 'silver', position: { x: 20, y: 40 } },
    { tier: 'gold', position: { x: 50, y: 40 } },
    { tier: 'gold', position: { x: 80, y: 40 } },
    { tier: 'bronze', position: { x: 20, y: 60 } },
    { tier: 'bronze', position: { x: 50, y: 60 } },
    { tier: 'silver', position: { x: 80, y: 60 } },
    { tier: 'silver', position: { x: 20, y: 80 } },
    { tier: 'bronze', position: { x: 50, y: 80 } },
    { tier: 'bronze', position: { x: 80, y: 80 } },
  ],
  13: [
    { tier: 'gold', position: { x: 20, y: 20 } },
    { tier: 'gold', position: { x: 50, y: 20 } },
