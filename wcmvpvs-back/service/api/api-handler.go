...
func (rt *_router) Handler() chi.Router {
	...
	rt.router.Post("/merchant/login", rt.wrap(rt.merchantLogin))
	rt.router.Get("/merchant/dashboard/summary", rt.wrapMerchant(rt.merchantDashboardSummary))
	rt.router.Get("/merchant/orders", rt.wrapMerchant(rt.listMerchantOrders))
	rt.router.Post("/merchant/orders/{id}/status", rt.wrapMerchant(rt.updateMerchantOrderStatus))
	rt.router.Get("/merchant/products", rt.wrapMerchant(rt.listMerchantProducts))
	rt.router.Post("/merchant/products", rt.wrapMerchant(rt.upsertMerchantProduct))
	rt.router.Post("/merchant/products/{id}/flags", rt.wrapMerchant(rt.updateMerchantProductFlags))
