...
export const PLAYER_LAYOUTS: Record<number, PlayerLayoutSlot[]> = {
  12: [
    { tier: 'gold', position: { x: 20, y: 18 } },
    { tier: 'gold', position: { x: 50, y: 18 } },
    { tier: 'silver', position: { x: 80, y: 18 } },
    { tier: 'silver', position: { x: 20, y: 32 } },
    { tier: 'gold', position: { x: 50, y: 32 } },
    { tier: 'gold', position: { x: 80, y: 32 } },
    { tier: 'bronze', position: { x: 20, y: 68 } },
    { tier: 'bronze', position: { x: 50, y: 68 } },
    { tier: 'silver', position: { x: 80, y: 68 } },
    { tier: 'silver', position: { x: 20, y: 82 } },
    { tier: 'bronze', position: { x: 50, y: 82 } },
    { tier: 'bronze', position: { x: 80, y: 82 } },
  ],
  13: [
    { tier: 'gold', position: { x: 20, y: 18 } },
    { tier: 'gold', position: { x: 50, y: 18 } },
