...
func (rt *_router) Handler() chi.Router {
	...
	rt.router.Get("/events/{eventId}/branded-game", rt.wrap(rt.getBrandedGame))
	rt.router.Post("/events/{eventId}/branded-game/result", rt.wrap(rt.postBrandedGameResult))
	rt.router.Get("/events/{eventId}/branded-game/stackit-leaderboard", rt.wrap(rt.getStackItLeaderboard))
	...
	rt.router.Get("/events/{eventId}/support/leaderboard", rt.wrap(rt.getFanSupportLeaderboard))
	rt.router.Post("/events/{eventId}/support/donate", rt.wrap(rt.postFanSupportDonation))
